                    ...
                    <div class="widget-content">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{asset('assets/img/profile-7.jpe')}}g" alt="avatar">Andy King</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{asset('assets/img/profile-4.jpeg')}}" alt="avatar">Irene Collins</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{asset('assets/img/profile-10.jpeg')}}" alt="avatar">Laurie Fox</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{asset('assets/img/profile-13.jpeg')}}" alt="avatar">Luke Ivory</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{asset('assets/img/profile-5.jpeg')}}" alt="avatar">Ryan Collins</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{asset('assets/img/profile-6.jpeg')}}" alt="avatar">Nia Hillyer</div></td>
                                ...
                                <tr>
                                    <td><div class="td-content customer-name"><img src="{{asset('assets/img/profile-11.jpeg')}}" alt="avatar">Sonia Shaw</div></td>
                    ...
                    <div class="widget-content">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    <td><div class="td-content product-name"><img src="{{asset('assets/img/watch.jp')}}g" alt="product">Watch</div></td>
