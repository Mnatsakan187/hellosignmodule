            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                @if ($page_name != 'alt_menu' && $page_name != 'blank_page' && $page_name != 'boxed' && $page_name != 'breadcrumb' )
                    ...
                    <li class="menu {{ ($category_name === 'user-management') ? 'active' : '' }}">
                        <a href="{{route('user-management.index')}}" data-active="{{ ($category_name === 'user-management') ? 'true' : 'false' }}" aria-expanded="{{ ($category_name === 'user-management') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu {{ ($category_name === 'signature-contract') ? 'active' : '' }}">
                        <a href="{{route('signature-contract.index')}}" data-active="{{ ($category_name === 'signature-contract') ? 'true' : 'false' }}" aria-expanded="{{ ($category_name === 'signature-contract') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                                <span>Signature contracts</span>
                            </div>
                        </a>
                    </li>

                    <li class="menu {{ ($category_name === 'signature-request') ? 'active' : '' }}">
                        <a href="{{route('signature-request.index')}}" data-active="{{ ($category_name === 'signature-request') ? 'true' : 'false' }}" aria-expanded="{{ ($category_name === 'signature-request') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
